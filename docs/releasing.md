...
- `CHANGELOG.md` contains the package changelog.
- Detailed release notes live under `docs/release-notes/`.
- GitHub release notes are generated by the release workflow from commits and labels, with the local release note file used as the source of truth for manual review.
