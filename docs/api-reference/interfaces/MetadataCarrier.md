...
[Veyra Node.js SDK](../globals.md) / MetadataCarrier

# Interface: MetadataCarrier

Defined in: src/types/shared.ts:22

## Extended by

- [`ChatCompletion`](ChatCompletion.md)
- [`ChatCompletionChunk`](ChatCompletionChunk.md)
- [`TextCompletion`](TextCompletion.md)
- [`TextCompletionChunk`](TextCompletionChunk.md)
- [`VeyraResponse`](VeyraResponse.md)
- [`ResponseStreamEvent`](ResponseStreamEvent.md)
...
- [`BillingAccess`](BillingAccess.md)
- [`BillingUsagePage`](BillingUsagePage.md)
- [`APIKey`](APIKey.md)
