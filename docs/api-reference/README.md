...
See the full docs in [`docs/`](_media/docs), the hand-written SDK reference in [`docs/sdk-api-reference.md`](_media/sdk-api-reference.md), and generated TypeDoc API reference in `docs/api-reference/`.
Release workflow guidance is documented in [`docs/releasing.md`](_media/releasing.md).

## Project Policies

- [Contributing](_media/CONTRIBUTING.md)
- [Code of Conduct](_media/CODE_OF_CONDUCT.md)
- [Security](_media/SECURITY.md)
- [Support](_media/SUPPORT.md)
- [Release Process](_media/RELEASE.md)
