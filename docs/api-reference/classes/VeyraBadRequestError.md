...
[Veyra Node.js SDK](../globals.md) / VeyraBadRequestError

# Class: VeyraBadRequestError

Defined in: [src/core/errors.ts:41](https://github.com/tubox-labs/veyra-nodejs/blob/871a6c1e724391f3c26ecbbdab26c3924bd3bb48/src/core/errors.ts#L41)
...
- [`VeyraPayloadTooLargeError`](VeyraPayloadTooLargeError.md)

## Constructors

### Constructor

> **new VeyraBadRequestError**(`message`, `options?`): `VeyraBadRequestError`
