...
[Veyra Node.js SDK](../globals.md) / VeyraProviderUnavailableError

# Class: VeyraProviderUnavailableError

Defined in: [src/core/errors.ts:75](https://github.com/tubox-labs/veyra-nodejs/blob/871a6c1e724391f3c26ecbbdab26c3924bd3bb48/src/core/errors.ts#L75)
...
> **new VeyraProviderUnavailableError**(`message`, `options?`): `VeyraProviderUnavailableError`
