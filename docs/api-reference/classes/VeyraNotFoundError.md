...
[Veyra Node.js SDK](../globals.md) / VeyraNotFoundError

# Class: VeyraNotFoundError

Defined in: [src/core/errors.ts:45](https://github.com/tubox-labs/veyra-nodejs/blob/871a6c1e724391f3c26ecbbdab26c3924bd3bb48/src/core/errors.ts#L45)
...
> **new VeyraNotFoundError**(`message`, `options?`): `VeyraNotFoundError`
