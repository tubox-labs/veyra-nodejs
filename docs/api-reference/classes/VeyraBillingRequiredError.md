...
[Veyra Node.js SDK](../globals.md) / VeyraBillingRequiredError

# Class: VeyraBillingRequiredError

Defined in: [src/core/errors.ts:43](https://github.com/tubox-labs/veyra-nodejs/blob/871a6c1e724391f3c26ecbbdab26c3924bd3bb48/src/core/errors.ts#L43)
...
> **new VeyraBillingRequiredError**(`message`, `options?`): `VeyraBillingRequiredError`
