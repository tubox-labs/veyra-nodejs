...
[Veyra Node.js SDK](../globals.md) / VeyraAuthenticationError

# Class: VeyraAuthenticationError

Defined in: [src/core/errors.ts:42](https://github.com/tubox-labs/veyra-nodejs/blob/5b58b1304854b72776ec2ad1c66004804c3609a6/src/core/errors.ts#L42)
...
> **new VeyraAuthenticationError**(`message`, `options?`): `VeyraAuthenticationError`
